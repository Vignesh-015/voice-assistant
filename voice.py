...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak("I have been created by Vigneshwaran.")
            ...
            speak("Thanks to Vigneshwaran. Further, it's a secret")

        elif 'desktop' in query:
            speak("Opening Desktop")
            power = r"your desktop path"
            os.startfile(power)
            ...
            speak("I am your virtual assistant created by Vigneshwaran")

        elif 'reason for you' in query:
            speak("I was created as a Minor project by Mister Vigneshwaran")
            ...
            if x["cod"] != "404":
                if "main" in x:
                     ...
                     speak(f"The temperature in {city_name} is {current_temperature} Kelvin, "
                           f"with atmospheric pressure {current_pressure} hPa, "
                           f"humidity {current_humidity}%, and the weather is {weather_description}")
                else:
                     speak("Weather information not available for this city. Please try again.")
